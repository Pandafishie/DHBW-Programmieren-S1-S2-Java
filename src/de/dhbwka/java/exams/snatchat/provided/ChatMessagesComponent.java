package de.dhbwka.java.exams.snatchat.provided;
...
/**
 * Bereitgestelltes Oberflaechenelement zur Anzeige der Chat-Nachrichten auf
 * Basis einer beliebigen Komponente.
 *
...
public class ChatMessagesComponent extends JScrollPane {
	...
	public void add(JComponent component) {
		...
		this.messagesPanel.add(component, new GridBagConstraints(0, this.messagesCount++, 1, 1, 1., 0.,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		this.messagesPanel.add(this.fillerY, new GridBagConstraints(0, this.messagesCount, 1, 1, 1., 1.,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
