...
public class Nimmspiel {
	...
	public void spielzug(int spielerNr) {
		...
		do {
			System.out.print("Spieler " + spielerName[spielerNr] + ": Von welchem Haufen ziehen Sie Kugeln? ");
		...
		eingabeFehler = true;
		do {
			System.out.print("Spieler " + spielerName[spielerNr] + ": Wieviele Kugeln ziehen Sie? ");
	...
	public String toString() {
		return "Spieler: " + spielerName[0] + " und " + spielerName[1] + ", Haufen 1: " + haufen[0]
				+ " Kugel(n), Haufen 2: " + haufen[1] + " Kugel(n)";
	}
