...
public class Point {
	...
	/**
	 * Returns a new Point with the coordinates of this Point mirrored (flipped) at
	 * the x axis.
	 *
	...
	/**
	 * Returns a new Point with the coordinates of this Point mirrored (flipped) at
	 * the origin (0, 0) of the coordinate space.
	 *
	 * @return the resulting Point
	 */
	 ...
	 *
	 * @param p the Point of which the distance from this Point shall be calculated
	...
	public static void main(String[] args) {
		...
		System.out.println("Abstand: " + pointA.getDistance(pointB));
